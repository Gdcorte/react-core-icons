...
const Fat: IconComponent = ({ className, ...props }) => {
  // https://uxwing.com/fat-icon/
  return (
    <BaseSvg
      iconName="anatomy-fat"
      className={className}
      viewBox="0 0 84.21 122.88"
      {...props}
    >
      <g>
        <path
