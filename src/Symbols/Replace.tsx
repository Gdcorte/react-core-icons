...
const Replace: IconComponent = ({ className, ...props }) => {
  // https://uxwing.com/replace-icon/

  return (
    <BaseSvg
      iconName="symbols-replace"
      className={className}
      clipRule="evenodd"
      fillRule="evenodd"
