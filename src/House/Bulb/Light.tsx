...
const LightThemeIcon: IconComponent = ({ className, ...props }) => {
  // https://uxwing.com/light-bulb-color-icon/

  return (
    <StyledSvg
      iconName="house-bulb-light"
      className={className}
      viewBox="0 0 114.98 122.88"
      {...props}
    >
      <path
        className="light-bulb-dark"
      ...
      />
      <path
        className="light-bulb-yellow stripe"
